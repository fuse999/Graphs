    ...
    def dft(self, starting_vertex):
        ...
        while s.size() > 0:
            ...
            if l not in visited:
                print(l)
                visited.add(l)
                for neighbor in self.get_neighbors(l):
                    s.push(neighbor)
    ...
    def bfs(self, starting_vertex, destination_vertex):
        ...
        while q.size() > 0:
            ...
            if v not in visited:
                # Mark it as visited
                visited.add(v)
                # CHECK IF IT'S THE destination_vertex
    ...
    def dfs_recursive(self, starting_vertex, destination_vertex,
        ...
        for neighbor in self.get_neighbors(starting_vertex):
            if neighbor not in visited:
                new_path = self.dfs_recursive(neighbor,destination_vertex,visited = visited,path = path)
                if new_path:
                    return new_path
